...
namespace OrderCloudMessageSender.Controllers
{
	...
	public class TwilioController : Controller
	{
		...
		public async Task<MessageResource> SendOrderSubmittedMessage([FromBody] OrderMessage notification)
		{
		...
		public async Task<MessageResource> SendOrderSubmittedForApproval([FromBody] OrderMessage notification)
		{
		...
		public async Task<MessageResource> SendOrderApproved([FromBody] OrderMessage notification)
		{
		...
		public async Task<MessageResource> SendOrderDeclined([FromBody] OrderMessage notification)
		{
		...
		public async Task<MessageResource> SendOrderSubmittedForYourApproval([FromBody] OrderMessage notification)
		{
		...
		public async Task<MessageResource> OrderSubmittedForYourApprovalHasBeenDeclined([FromBody] OrderMessage notification)
		{
